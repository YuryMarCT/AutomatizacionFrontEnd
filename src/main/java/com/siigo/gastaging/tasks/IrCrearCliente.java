...
public class IrCrearCliente implements  Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        System.out.println("El actor ha hecho clic en el botón 'Crear' dentro del shadow DOM");
        try {
            Thread.sleep(5000);
        ...
        System.out.println("El actor ha hecho clic en el botón  Cliente dentro del shadow DOM");
